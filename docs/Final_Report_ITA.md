...
Il problema è formalizzato come **Semantic Segmentation binaria**: dato un frame $I \in \mathbb{R}^{H \times W \times 3}$, il modello produce una maschera \hat{M} \in \mathbb{R}^{H \times W}, \quad \hat{M}_{ij} \in \{0,1\} dove:
