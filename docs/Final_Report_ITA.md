...
Il problema è formalizzato come **Semantic Segmentation binaria**: dato un frame $I \in \mathbb{R}^{H \times W \times 3}$, il modello produce una maschera $\hat{M} : \{1,\dots,H\} \times \{1,\dots,W\} \to \{0,1\}$ dove:
